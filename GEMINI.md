...
3. **No Destructive Ops**: Never force push, hard reset, or merge to main
4. **No PR Creation**: The Refinery handles merging; just push and call `gt_done`
5. **Pre-Submission Gates**: Run `task quality` before calling `gt_done`
